...
const AppTitle = () => {
  ...
  return (
    <div
      id="title"
      className="relative flex space-y-7 flex-col pt-14 md:pt-14 items-center "
    >
      <div className="flex flex-row items-start">
        <span className="text-3xl text-center font-bold text-white xs:text-5xl sm:text-6xl">
          AI ChatGPT Prompts Template
        </span>
      </div>
      <div className="flex flex-row items-start">
        <p className="md:text-xl text-md text-zinc-400 px-6 text-center  md:px-0">
          Simplify your workflow and work smarter with the power of ChatGPT.
        </p>
      </div>
      <div className='md:px-0 flex px-6  w-full items-center justify-center mx-auto '>
